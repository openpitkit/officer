...
func orderPresentationByID(
	ctx context.Context, svc backend.ControlPlane, id domain.ExternalID,
) orderPresentation {
...
func handleCheckOrder(svc backend.ControlPlane) http.HandlerFunc {
...
func handleListOrders(svc backend.ControlPlane) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleGetOrder(svc backend.ControlPlane) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleGetOrderEventReproduction(svc backend.ControlPlane) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleApplyExecutionReport(svc backend.ControlPlane) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id, err := httpx.PathOrderExternalID(r)
		if err != nil {
			httpx.WriteBadRequestProblem(w, err.Error(), "url_encoding")
