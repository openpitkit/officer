...
export default tseslint.config(
  ...
  {
    // Test files: literal strings are test data, not user-facing copy, and the
    // react-refresh component-export guard is irrelevant to a non-bundled test
    // module. Both rules would otherwise fire on every case.
