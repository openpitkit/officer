...
func TestBackupExportCarriesVersionAndScope(t *testing.T) {
	...
	if archive.Manifest.SchemaVersion != 2 {
		t.Fatalf("schema version = %d, want 2", archive.Manifest.SchemaVersion)
	}
...
func TestBackupRestoreRollsBackOnFailure(t *testing.T) {
	...
	archive := backup.NewArchive(now, "test", 2, backup.Scope{All: true}, backup.Data{
...
func TestBackupRestoreCountsMixedMarketDataQuotes(t *testing.T) {
	...
	archive := backup.NewArchive(now, "test", 2, backup.Scope{All: true},
		backup.Data{
...
func TestBackupRestoreReplaceAllQuotesOnlySkipsMissingTargetInstruments(t *testing.T) {
	...
	archive := backup.NewArchive(now, "test", 2,
