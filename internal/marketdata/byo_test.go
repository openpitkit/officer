...
func TestBYOConnector_PushForwards(t *testing.T) {
	...
	want := fwmarketdata.QuoteUpdate{Base: testMarketDataAssetID("AAPL"), Quote: testMarketDataAssetID("USD"), Mark: "100"}
...
func TestBYOConnector_PushAfterCloseIsNoop(t *testing.T) {
	...
	if err := c.Push(
		context.Background(), fwmarketdata.QuoteUpdate{Base: testMarketDataAssetID("AAPL"), Quote: testMarketDataAssetID("USD"), Mark: "1"},
	); err != nil {
...
func TestBYOConnector_PushHonorsContextWhenQueueIsFull(t *testing.T) {
	...
	defer cancel()
	err := c.Push(ctx, fwmarketdata.QuoteUpdate{Base: testMarketDataAssetID("AAPL"), Quote: testMarketDataAssetID("USD"), Mark: "2"})
